...
Filter webhook payloads before scheduling. Payloads contain event-time fields only; derived fields are added at delivery. Return empty array to prevent webhook.
