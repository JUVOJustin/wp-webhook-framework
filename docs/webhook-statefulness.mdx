---
title: Webhook Statefulness
description: Webhook instances are singletons and must remain stateless to prevent race conditions.
sidebar:
  order: 7
---
...
See [Custom Webhooks](./custom-webhooks.mdx) for implementation examples.
